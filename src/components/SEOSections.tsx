  ...
  return (
    <section className="w-full max-w-5xl mx-auto py-16 md:py-24 px-4">
      <div className="space-y-6 text-center mb-12 md:mb-16">
        <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-foreground uppercase">INDUSTRIAL BASE64 WORKFLOW</h2>
        <p className="text-base md:text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed font-medium px-2">
          Forge Studios is a high-performance web performance tool designed to streamline modern asset delivery pipelines. 
          By synthesizing binary data into optimized Base64 code, we eliminate HTTP overhead for critical path assets.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 mt-12">
        <div className="glass-card p-6 md:p-10 rounded-[1.5rem] md:rounded-[2.5rem] border border-foreground/5 flex flex-col h-full">
          <h3 className="text-xl md:text-2xl font-black mb-6 tracking-tight">How to use our Base64 String Generator</h3>
          <div className="space-y-6 text-sm text-muted-foreground leading-relaxed flex-1">
            <div className="space-y-2">
              <p className="font-bold text-foreground">1. HTML Image Encoder Implementation</p>
            ...
            <div className="space-y-2">
              <p className="font-bold text-foreground">2. CSS Image Encoder Implementation</p>
              <code className="block p-4 bg-foreground/5 rounded-xl font-code text-[10px] md:text-xs overflow-x-auto whitespace-pre-wrap break-all">
        ...
        <div className="glass-card p-6 md:p-10 rounded-[1.5rem] md:rounded-[2.5rem] border border-foreground/5 flex flex-col h-full overflow-hidden">
          <h3 className="text-xl md:text-2xl font-black mb-6 tracking-tight">Web Performance Audit</h3>
...
export function FAQSection() {
  const faqs = [
    {
      q: "What is the 33% overhead rule for Base64?",
    ...
    {
      q: "Is batch processing limited in the Forge?",
    ...
    {
      q: "How does this Base64 tool impact SEO?",
  ...
  return (
    <section className="w-full max-w-4xl mx-auto py-16 md:py-24 px-4 border-t border-foreground/5">
      <h2 className="text-2xl md:text-3xl font-black text-center mb-10 md:mb-12 tracking-tighter uppercase">TECHNICAL ADVISORY & FAQ</h2>
