...
export function NavigationHeader() {
  ...
  const tools = [
    ...
    { 
      ...
      icon: ImageIcon, 
      desc: "WebP bitstream compression",
      color: "text-accent"
    },
    { 
      name: "SVG Studio", 
      ...
      icon: FileCode, 
      desc: "Vector path orchestration",
    ...
    { 
      ...
      icon: Braces, 
      desc: "Data structure optimization",
      color: "text-primary"
    }
  ]
        ...
        <div className="flex items-center gap-1">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-2 px-3 py-2 rounded-xl hover:bg-foreground/5 transition-all text-[10px] font-black uppercase tracking-[0.2em] outline-none group">
