      ...
      <main className="container mx-auto px-4 pt-32 pb-32 relative z-10 max-w-4xl">
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter leading-none">SYSTEM <br /><span className="text-gradient">CAPABILITIES</span></h1>
            <p className="text-lg text-muted-foreground font-medium max-w-2xl leading-relaxed">
              Detailed breakdown of the Forge Synthesis Engine's limits, processing capabilities, and data retention policies.
            </p>
          </div>

          <div className="grid gap-8">
            <section className="glass-card p-8 md:p-12 rounded-[2.5rem] border-white/10 space-y-8">
              <h2 className="text-2xl font-black tracking-tight">Processing Limits</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="glass-card p-8 rounded-[2rem] border-white/10 space-y-4">
                ...
                <h3 className="text-xl font-black">MIME Support</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Forge supports <code>image/png</code>, <code>image/jpeg</code>, <code>image/webp</code>, and <code>image/svg+xml</code>. Binary streams are sanitized before encoding.
                </p>
              </div>
              <div className="glass-card p-8 rounded-[2rem] border-white/10 space-y-4">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Large Base64 strings are truncated to 10,000 characters for cloud storage to maintain database integrity while preserving the most useful data.
                </p>
              </div>
            </div>
          </div>
