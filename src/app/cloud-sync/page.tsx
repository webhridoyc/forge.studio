                    ...
                    <div className="p-6 md:p-8 space-y-6 flex-1">
                      <div className="flex items-start justify-between">
                        <div className="space-y-1">
                          ...
                          <h4 className="font-black text-lg tracking-tight truncate max-w-[140px]">{snippet.fileName}</h4>
                        </div>
                        <div className="h-16 w-16 rounded-2xl bg-foreground/5 p-1 border border-foreground/5 overflow-hidden group-hover:scale-110 transition-transform shadow-inner">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent className="w-56 p-2 rounded-[1.5rem] glass-card border-white/10 shadow-2xl z-[200]">
                          ...
                          >
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-widest">CSS Property</span>
                          </DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
